	...
	<div class="footer-collumns-container">
		<div class="footer-collumns">
			<div class="footer-collumns-content t-a-left">
				<h3 class="o400 oswald">2015 COPYRIGHT © JKLEINJUNGE</h3>
				<h4 class="o300 oswald">All rights reserved.</h4>
				<p class="oswald o300">
					Tel :<span class="o400">  + 336 47324204</span><br>
					Email : <a href="mailto:cuneo.jeremie@gmail.com"><span class="o400">cuneo.jeremie@gmail.com</span></a><br>
					Address :<span class="o400">  89 Chemin Joseph Aiguier, 13009 Marseille</span>
				</p>
			</div>
		</div>
		<div class="footer-collumns">
			...
			<div class="footer-collumns">
				<ul class="footer-collumns-content oswald">
					<li class="dot">&bull; <a href="#top">  Top</a></li>
					<li class="dot">&bull; <a href="#skills">  Skills</a></li>
					<li class="dot">&bull; <a href="#projects"> Projects</a></li>
					<li class="dot">&bull; <a href="#work">  Work</a></li>
					<li class="dot">&bull; <a href="#about-me"> About me</a></li>
					<li class="dot">&bull; <a href="#contact"> Contact</a></li>
				</ul>
